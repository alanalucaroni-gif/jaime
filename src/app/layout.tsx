...
import { CrepesRouteTransitionProvider } from "@/components/motion/CrepesRouteTransition";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="pt-BR" className={`${modak.variable} ${mouseMemoirs.variable}`}><body><CrepesRouteTransitionProvider><SmoothScroll>{children}</SmoothScroll></CrepesRouteTransitionProvider></body></html>;
}
