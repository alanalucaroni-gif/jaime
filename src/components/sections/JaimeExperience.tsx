...
export function JaimeExperience() {
  ...
  useGSAP(() => {
    ...
    gsap.timeline({ scrollTrigger: { trigger: "[data-savory]", start: "top top", end: "+=1450", pin: true, scrub: .75, anticipatePin: 1 } })
      ...
      .to("[data-savory-product]", { rotate: 7, transformOrigin: "50% 50%", duration: .2, ease: "power2.inOut" }, .34)
      .to("[data-savory-product]", { rotate: 4, duration: .055, ease: "power2.inOut" }, .54)
      .to("[data-savory-product]", { rotate: 9, duration: .055, ease: "power2.inOut" }, .595)
      .to("[data-savory-product]", { rotate: 7, duration: .075, ease: "power2.out" }, .64)
