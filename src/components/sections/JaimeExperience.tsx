...
export function JaimeFinal() {
  return <section className="story-final"><div className="story-final-copy"><p>FAIT AVEC AMOUR</p><h2>VÁ DE J&apos;AIME.<br/>VÁ DE CREPE.</h2><CrepesRouteLink href={brand.orderUrl}>PEDIR AGORA <b>↗</b></CrepesRouteLink></div><div className="story-final-photo"><video src="/images/jaime/jaime.mp4" autoPlay muted loop playsInline preload="metadata" aria-label="Senhor J'aime apresentando um crepe doce" /></div></section>;
}
