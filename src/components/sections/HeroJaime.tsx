...
export function HeroJaime() {
  ...
  return <section ref={ref} id="top" className="story-hero">
    <header data-nav className="story-nav shell"><a href="#top" aria-label="J'aime — início"><Image src="/images/jaime/logo.png" alt="J'aime Crêpe Française" width={185} height={96} priority /></a><nav><CrepesRouteLink href="/crepes">Peça seu crepe ↗</CrepesRouteLink><a href="#experiencia">Experiência</a><a href="#camadas">Ingredientes</a><CrepesRouteLink className="story-order" href={brand.orderUrl}>Pedir agora <b>↗</b></CrepesRouteLink></nav></header>
